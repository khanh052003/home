...
<head>
    ...
    <link rel="icon" href="./assetss/img/icon-home/small-logo.svg" type="image/gif" sizes="16x16">
    <!-- reset css -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/8.0.1/normalize.min.css">
    <!-- css grid để kết hợp chia khung và responsive -->
    <link rel="stylesheet" href="{{asset('assetss/css/grid.css')}}">
    <!-- css mấy cái chung ban đầu -->
    <link rel="stylesheet" href="{{asset('assetss/css/base.css')}}">
    <!-- css chính -->
    ...
    <link rel="stylesheet" href="{{asset('assetss/fonts/fontawesome-free-5.15.3-web/css/all.min.css')}}">
</head>
<body>
    <div class="main" style="background-image: url(./assetss/img/background-theme/backroundThemes/0.svg);">
        <div class="grid">
            <!-- BEGIN SIDEBAR -->
            ...
            <div class="main-container">
                ...
                <div class="header-wrapper">
                    <div class="header">
                        <div class="header__undo mobile-hiden js__sub-color">
                                ...
                                <a class="hover js__toast" href="{{url('/')}}">
                                    <i class="fas fa-arrow-left hover js__toast">
                                    </i>
                                    </a>
                        ...
                        <div class="header__width-search js__backgroundColor">
                            <form id="searchformm" action="{{ route('find') }}" method="post">
                                {{ csrf_field() }}
                            <div class="header__width-search js__backgroundColor">
                            <button style="background: none; border: none;" class="fas fa-search header__width-search-icon " type="submit"></button>
                                   
                            <!-- header__width-search-input--white -->
                            <!-- header__width-search-input--dark -->
                            <input placeholder="Nhập tên bài hát, nghệ sĩ hoặc MV . . ." type="search" id="search-input" name="keywords" class="header__width-search-input">
                        ...
                        <div class="header__right">
                            ...
                            <div class="header__user hover">
                                <a href="">
                                    <img src="./img/c5.jpg" alt="user" class="header__user-img">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-container-pertional js__container-panes active">
                    <div class="profile">
                        <a href="">
                            <img src="./img/c5.jpg" alt="avata" class="profile__img">
                        </a>
                        <span class="profile__name js__main-color">Mr. Duck</span>
                    ...
                    <div class="music__option">
                        <ul class="music__option-list js__backgroundColor">
                            ...
                            <li class="tabs-item music__option-item js__main-color">Tổng quan</li>
                            <li class="tabs-item music__option-item js__main-color  music__option-item--active">Bài hát</li>
                    ...
                    <!-- option 0 -->
                    <div class="option-all panes-item">
                        <!-- song -->
                        <div class="option-all__song option-all__margin_bot">
                            <div class="option-heading option-all__song-heading ">
                                <h3 class="option-heading-name option-all__song-heading-left mobile-hiden js__main-color">Kết quả tìm kiếm bài hát</h3>
                            ...
                            <div class="grid row">
                                ...
                                <div class="col l-3 m-0 s-0">
                                    <div class="option-all__song-slider">
                                        <!-- first second -->
                                        <img src="./assetss/img/slider/0.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-first">
                                        <img src="./assetss/img/slider/1.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-first">
                                        <img src="./assetss/img/slider/2.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/3.jpg" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/4.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/5.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/6.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/7.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/8.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/9.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/10.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/11.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/12.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/13.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/14.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                        <img src="./assetss/img/slider/15.webp" alt="anh slider" class="option-all__song-slider-img option-all__song-slider-img-third">
                                    </div>
                                </div>
                                @else
                                <h1 class="" style="text-align: center; color: white;">Không tìm thấy bài hát phù hợp với từ khóa !</h1>
                                @endif
                                        ...
                                        <ul class="option-all__songs-list songs-list">
                                            ...
                                            <!-- <li class="songs-item songs-item--active">
                                                <div class="songs-item-left">
                                                    <img src="./assetss/img/songs/0.webp" alt="danh sanh nhac" class="songs-item-left-img">
                                    ...
                                    <div class="col l-2-4 m-3 s-6 mobile-margin-bot-10px">
                                        <li class="option-all__playlist-item">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img" style="background-image: url(./assetss/img/playlist/1.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content">
                                                <div class="option-all__playlist-item-content-name1 js__main-color">Replay</div>
                                                <div class="option-all__playlist-item-content-name2 js__sub-color">Phúc tee</div>
                                            </div>
                                        </li>
                                    </div>
                                    <div class="col l-2-4 m-3 s-6 mobile-margin-bot-10px">
                                        <li class="option-all__playlist-item">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img" style="background-image: url(./assetss/img/playlist/2.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content">
                                    ...
                                    <div class="col l-2-4 m-3 s-6 mobile-margin-bot-10px">
                                        <li class="option-all__playlist-item">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-fix" style="background-image: url(./assetss/img/playlist/3.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content">
                                    ...
                                    <div class="col l-2-4 m-0 s-6 mobile-margin-bot-10px">
                                        <li class="option-all__playlist-item option-all__playlist-item-margin-top">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img" style="background-image: url(./assetss/img/playlist/4.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content">
                                                <div class="option-all__playlist-item-content-name1 js__main-color">Nhạc của Bạn</div>
                                                <div class="option-all__playlist-item-content-name2 js__sub-color">Zing MP3</div>
                                            </div>
                                        </li>
                                    </div>
                                    ...
                                    <div class="col l-4 m-4 s-12 mobile-margin-bot-30px">
                                        <li class="option-all__playlist-item">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-mv" style="background-image: url(./assetss/img/mv/1.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-mv">
                                                <img src="./assetss/img/mv/icon1.jpg" alt="thanh hung" class="option-all__playlist-item-content-img">
                                    ...
                                    <div class="col l-4 m-4 s-12 mobile-margin-bot-30px">
                                        <li class="option-all__playlist-item">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-mv" style="background-image: url(./assetss/img/mv/2.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-mv">
                                                <img src="./assetss/img/mv/icon2.jpg" alt="Han Sara" class="option-all__playlist-item-content-img">
                                                <div class="option-all__playlist-item-content-name">
                                    ...
                                    <div class="col l-4 m-4 s-12 mobile-margin-bot-30px">
                                        <li class="option-all__playlist-item">
                                            <div class="option-all__playlist-item-img-wrapper">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-mv" style="background-image: url(./assetss/img/mv/3.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-mv">
                                                <img src="./assetss/img/mv/icon3.jpg" alt="Alex Sensation" class="option-all__playlist-item-content-img">
                                                <div class="option-all__playlist-item-content-name">
                                    ...
                                    <div class="col l-2-4 m-4 s-6 mobile-margin-bot-30px ">
                                        <li class="option-all__playlist-item option-all__playlist-item-margin_top">
                                            <div class="option-all__playlist-item-img-wrapper option-all__playlist-item-img-wrapper-mv">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-singer" style="background-image: url(./assetss/img/singer/1.webp);"></div>
                                            </div>
                                    ...
                                    <div class="col l-2-4 m-4 s-6 mobile-margin-bot-30px ">
                                        <li class="option-all__playlist-item option-all__playlist-item-margin_top">
                                            <div class="option-all__playlist-item-img-wrapper option-all__playlist-item-img-wrapper-mv">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-singer" style="background-image: url(./assetss/img/singer/2.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-singer">
                                    ...
                                    <div class="col l-2-4 m-4 s-6 mobile-margin-bot-30px ">
                                        <li class="option-all__playlist-item option-all__playlist-item-margin_top">
                                            <div class="option-all__playlist-item-img-wrapper option-all__playlist-item-img-wrapper-mv">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-singer" style="background-image: url(./assetss/img/singer/3.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-singer">
                                    ...
                                    <div class="col l-2-4 m-4 s-6 mobile-margin-bot-30px ">
                                        <li class="option-all__playlist-item option-all__playlist-item-margin_top">
                                            <div class="option-all__playlist-item-img-wrapper option-all__playlist-item-img-wrapper-mv">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-singer" style="background-image: url(./assetss/img/singer/4.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-singer">
                                    ...
                                    <div class="col l-2-4 m-4 s-6 mobile-margin-bot-30px ">
                                        <li class="option-all__playlist-item option-all__playlist-item-margin_top">
                                            <div class="option-all__playlist-item-img-wrapper option-all__playlist-item-img-wrapper-mv">
                                                ...
                                                <div class="option-all__playlist-item-img option-all__playlist-item-img-singer" style="background-image: url(./assetss/img/singer/5.webp);"></div>
                                            </div>
                                            <div class="option-all__playlist-item-content-singer">
                ...
                <div class="main-container-discover js__container-panes ">
                    ...
                    <div class="container-discover__slider">
                        <div class="container-discover__slider-item container-discover__slider-item-first">
                            <img src="./assetss/img/slider-discover/1.jpg" alt="anh" class="container-discover__slider-item-img">
                        </div>
                        <div class="container-discover__slider-item container-discover__slider-item-second">
                            <img src="./assetss/img/slider-discover/2.jpg" alt="anh" class="container-discover__slider-item-img">
                        </div>
                        <div class="container-discover__slider-item container-discover__slider-item-third">
                            <img src="./assetss/img/slider-discover/3.jpg" alt="anh" class="container-discover__slider-item-img">
                        </div>
                        <div class="container-discover__slider-item container-discover__slider-item-four">
                            <img src="./assetss/img/slider-discover/4.jpg" alt="anh" class="container-discover__slider-item-img">
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col l-2-4 m-0 s-6 mobile-margin-bot-30px">
                                    <li class="option-all__playlist-item">
                                        ...
                                        <div class="option-all__playlist-item-content">
                                            <div class="option-all__playlist-item-content-name1 js__main-color white-color">Nhạc của bạn</div>
                                            <div class="option-all__playlist-item-content-name2 js__sub-color">Zing MP3</div>
                                        </div>
                                    </li>
                                </div>
                                ...
                                <ul class="zingchart-week__list">
                                    <li class="zingchart-week__item">
                                        ...
                                        <div class="zingchart-week__item-center">
                                            <img src="./assetss/img/songs/0.webp" alt="anh" class="zingchart-week__item-center-img">
                                    ...
                                    <li class="zingchart-week__item">
                                        ...
                                        <div class="zingchart-week__item-center">
                                            <img src="./assetss/img/songs/1.webp" alt="anh" class="zingchart-week__item-center-img">
                                            <div class="zingchart-week__item-center-content">
                                    ...
                                    <li class="zingchart-week__item">
                                        ...
                                        <div class="zingchart-week__item-center">
                                            <img src="./assetss/img/songs/2.webp" alt="anh" class="zingchart-week__item-center-img">
                                            <div class="zingchart-week__item-center-content">
                                    ...
                                    <li class="zingchart-week__item">
                                        ...
                                        <div class="zingchart-week__item-center">
                                            <img src="./assetss/img/songs/3.jpg" alt="anh" class="zingchart-week__item-center-img">
                                            <div class="zingchart-week__item-center-content">
                                    ...
                                    <li class="zingchart-week__item">
                                        ...
                                        <div class="zingchart-week__item-center">
                                            <img src="./assetss/img/songs/4.webp" alt="anh" class="zingchart-week__item-center-img">
                                            <div class="zingchart-week__item-center-content">
                    ...
                    <div class="theme-modal__body-group-wrapper">
                            ...
                            <ul class="theme-modal__body-group-list">
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme1/theme1.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Zing Music Awards</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme1/theme2.jpg);"></div>
                                    </div>
                        ...
                        <div class="theme-modal__body-group">
                            ...
                            <ul class="theme-modal__body-group-list">
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme2/theme1.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Rosé</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme2/theme2.jpg);"></div>
                                    </div>
                                ...
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img-wrapper">
                                            <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme2/theme3.jpg);"></div>
                                        </div>
                                    </div>
                                ...
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img-wrapper">
                                            <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme2/theme4.jpg);"></div>
                                        </div>
                                    </div>
                                ...
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme2/theme5.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Jennie Kim</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme2/theme6.jpg);"></div>
                                    </div>
                        ...
                        <div class="theme-modal__body-group">
                            ...
                            <ul class="theme-modal__body-group-list">
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme1.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Tối</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme2.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Tím</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme3.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Xanh đậm</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme4.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Xanh biển</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme5.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Xanh lá</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme6.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Nâu</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme7.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Hồng</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme3/theme8.jpg);"></div>
                                    </div>
                        ...
                        <div class="theme-modal__body-group">
                            ...
                            <ul class="theme-modal__body-group-list">
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme4/theme1.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Sáng</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme4/theme2.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Xám</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme4/theme3.jpg);"></div>
                                    </div>
                                    <span class="theme-modal__body-group-item-name js__main-color">Xanh nhạt</span>
                                </li>
                                <li class="theme-modal__body-group-item js-theme-item">
                                    <div class="theme-modal__body-group-item-img-wrapper">
                                        <div class="theme-modal__body-group-item-img" style="background-image: url(./assetss/img/background-theme/modalThemes/modalTheme4/theme4.jpg);"></div>
                                    </div>
                ...
                <div class="nextsong__box">
                    <div class="nextsong__fist">
                        <!-- <div class="nextsong__fist-item nextsong__item">
                            <div class="nextsong__item-img" style="background-image: url(./assetss/img/next-song/0.webp);">
                    ...
                    <div class="nextsong__last">
                        ...
                        <ul class="nextsong__last-list">
                            <!-- <li class="nextsong__last-item nextsong__item">
                                <div class="nextsong__item-img" style="background-image: url(./assetss/img/next-song/1.webp);">
                                    <div class="nextsong__item-playbtn"><i class="fas fa-play"></i></div>
                                </div>
                                <div class="nextsong__item-body">
            ...
            <div class="main-music-control">
                <div class="row">
                    <div class="col l-3 m-3 s-8"> <!-- ki hieu-->
                        <div class="music-control__left">
                            <div class="music-control__left-img-box">
                                <div class="music-control__left-img" style="background-image: url(./assetss/img/songs/0.webp);"></div>
                    ...
                    <div class="col l-6 m-7 s-4 rs__main-music-control-flex-1">
                        <div class="music-control__center">
                            ...
                            <audio id="audio" src="songs/di-ve-nha.mp3"></audio>
                        </div>
                    </div>
        ...
        <div class="mobile-player">
            <div class="mobile-player__headding">
                <img src="./assetss/img/icon-home/small-logo.svg" alt="icon-home" class="mobile-player__headding-img">
            ...
            <div class="mobile-player__body">
                <div class="mobile-player__body-thumb" style="background-image: url(./assetss/img/songs/0.webp);"></div>
    ...
    <script src="{{asset('assetss/javascript/main.js')}}"></script>
