...
window.addEventListener("load", function () {
  ...
  function renderMusic(song,indexSong) {
    ...
    <div class="song-content__info">
      <span class="song-content__info-image">
        <img src="images/thumbnails/${song.image}" alt="">
      ...
      <div class="song-content__user">
        <div class="song-content__name">${song.title}</div>
        <div class="song-content__author"><a href="#">${song.artist}</a></div>
      </div>
    </div>
  ...
  function handleRenderMusic(song) {
    ...
    musicAuthor.textContent = song.artist;
    musicImg.src = `images/thumbnails/${song.image}`;
